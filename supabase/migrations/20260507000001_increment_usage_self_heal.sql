-- Make increment_usage tolerant of users whose profile row is missing
-- (e.g. users who signed up before handle_new_user existed). Without this,
-- the FK from usage.user_id -> profiles.id fails on the first AI call.
