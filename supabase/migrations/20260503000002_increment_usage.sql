-- Atomic per-user monthly usage increment.
-- Called from the backend with the service role key.
-- Returns the new count, the limit, and whether this call was allowed.
